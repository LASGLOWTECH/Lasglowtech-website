...
const Update = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const cover = uploaded ? `${backendUploadsBase}/${uploaded}` : existingImage;
    ...
    <div className="rounded-2xl border border-Primarycolor/20 bg-bgcolor2 p-6">
      <div className="">
        ...
        <div className="space-y-4">
          ...
          <div className="h-[300px] overflow-y-auto overflow-x-hidden bg-white rounded-md">
            <ReactQuill
          ...
          <div className="flex flex-col items-start">
            ...
            <label
              htmlFor="file"
              className="text-gray-200 py-4 flex items-center font-medium cursor-pointer"
            >

...
const Create = () => {
  ...
  const backendUploadsBase = `${instance.defaults.baseURL}/uploads/images`;
  ...
  return (
    <div className="rounded-2xl border border-Primarycolor/20 bg-bgcolor2 p-6">
      <div>
        ...
        <input
          type="text"
          className="w-full border-none p-4 text-lg bg-[#F6F5FA] text-black focus:outline-none focus:ring-2 rounded-md"
          placeholder="Title"
          value={title}
          onChange={(e) => setTitle(e.target.value)}
        />

          <div className='h-[300px] w-full overflow-y-auto overflow-x-hidden border-none bg-white rounded-md'>
          <ReactQuill
        ...
        <div className='mx-3 col-span-1'>
          <div className='flex flex-col'>
            ...
            <label htmlFor='file' className='text-gray-200 py-4 flex items-center font-medium cursor-pointer'>
              ...
              <img
                src={
                  existingImage.startsWith('http')
                    ? existingImage
                    : `${backendUploadsBase}/${existingImage}`
                }
                alt="Current Post"

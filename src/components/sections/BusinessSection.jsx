...
const StatsSection = () => {
  ...
  const stats = [
    ...
    { value: 7, suffix: 'years+', label: 'Product Delivery' },
    { value: 2500, suffix: '+', label: 'Designed creatives' },
    { value: 15, suffix: '+', label: 'websites built' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
          ...
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="rounded-xl p-6 flex flex-col items-center text-center border border-Primarycolor/20 bg-bgcolor2/40 shadow-md shadow-Primarycolor/20 transition-shadow"
              >

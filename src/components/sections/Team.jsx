...
<h3 className="text-4xl pt-6 font-bold text-textcolor2">Our Team</h3>
<div className="border-2 my-2  border-orangeRed   mx-auto rounded-md w-[100px] "></div>
<p className="container py-6 px-6 mx-auto max-w-2xl text-textcolor2 leading-tight text-[18px] text-center">Meet the creative
            ...
            <div className="flex flex-col justify-center items-center py-2 ">
                <div className="flex flex-col  items-center">
                    <p className="text-l font-bold text-darkBlue  pt-3 ">
                       {team.Name}  </p>
                    <p className="text-[16px] text-muted text-center pt-1 pb-10 font-thin">
                        {team.Position} </p>
                </div>
